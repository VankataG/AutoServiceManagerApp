        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateOnly>(type: "date", nullable: false, comment: "Date of accepting the car for repair"),
                    Problem = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, comment: "Diagnose/Problem of the car, that have to be fixed"),
                    Status = table.Column<int>(type: "int", nullable: false, comment: "Status of the repair"),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairOrderEmployees", x => new { x.RepairOrderId, x.EmployeeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairOrderParts", x => new { x.RepairOrderId, x.PartId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairOrderEmployees_EmployeeId",
